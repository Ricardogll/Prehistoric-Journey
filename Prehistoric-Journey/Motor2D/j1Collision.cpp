...
j1Collision::j1Collision()
{
	...
	matrix[COLLIDER_WALL][COLLIDER_ENEMY_LIMIT] = false;
	matrix[COLLIDER_WALL][COLLIDER_COLLECTABLE] = false;
	...
	matrix[COLLIDER_PLAYER][COLLIDER_ENEMY_LIMIT] = false;
	matrix[COLLIDER_PLAYER][COLLIDER_COLLECTABLE] = false;
	...
	matrix[COLLIDER_PLAYER_ATTACK][COLLIDER_ENEMY_LIMIT] = false;
	matrix[COLLIDER_PLAYER_ATTACK][COLLIDER_COLLECTABLE] = false;
	...
	matrix[COLLIDER_ENEMY][COLLIDER_ENEMY_LIMIT] = true;
	matrix[COLLIDER_ENEMY][COLLIDER_COLLECTABLE] = true;
	...
	matrix[COLLIDER_LEDGE][COLLIDER_ENEMY_LIMIT] = false;
	matrix[COLLIDER_LEDGE][COLLIDER_COLLECTABLE] = false;
	...
	matrix[COLLIDER_LIANA][COLLIDER_ENEMY_LIMIT] = false;
	matrix[COLLIDER_LIANA][COLLIDER_COLLECTABLE] = false;
	...
	matrix[COLLIDER_LEVEL_END][COLLIDER_ENEMY_LIMIT] = false;
	matrix[COLLIDER_LEVEL_END][COLLIDER_COLLECTABLE] = false;
	...
	matrix[COLLIDER_DEAD][COLLIDER_ENEMY_LIMIT] = false;
	matrix[COLLIDER_DEAD][COLLIDER_COLLECTABLE] = false;

	matrix[COLLIDER_ENEMY_LIMIT][COLLIDER_PLAYER] = false;
	matrix[COLLIDER_ENEMY_LIMIT][COLLIDER_WALL] = false;
	matrix[COLLIDER_ENEMY_LIMIT][COLLIDER_LEDGE] = false;
	matrix[COLLIDER_ENEMY_LIMIT][COLLIDER_LIANA] = false;
	matrix[COLLIDER_ENEMY_LIMIT][COLLIDER_DEAD] = false;
	matrix[COLLIDER_ENEMY_LIMIT][COLLIDER_LEVEL_END] = false;
	matrix[COLLIDER_ENEMY_LIMIT][COLLIDER_ENEMY] = true;
	matrix[COLLIDER_ENEMY_LIMIT][COLLIDER_PLAYER_ATTACK] = false;
	matrix[COLLIDER_ENEMY_LIMIT][COLLIDER_ENEMY_LIMIT] = false;
	matrix[COLLIDER_ENEMY_LIMIT][COLLIDER_COLLECTABLE] = false;

	matrix[COLLIDER_COLLECTABLE][COLLIDER_PLAYER] = true;
	matrix[COLLIDER_COLLECTABLE][COLLIDER_WALL] = false;
	matrix[COLLIDER_COLLECTABLE][COLLIDER_LEDGE] = false;
	matrix[COLLIDER_COLLECTABLE][COLLIDER_LIANA] = false;
	matrix[COLLIDER_COLLECTABLE][COLLIDER_DEAD] = false;
	matrix[COLLIDER_COLLECTABLE][COLLIDER_LEVEL_END] = false;
	matrix[COLLIDER_COLLECTABLE][COLLIDER_ENEMY] = false;
	matrix[COLLIDER_COLLECTABLE][COLLIDER_PLAYER_ATTACK] = false;
	matrix[COLLIDER_COLLECTABLE][COLLIDER_ENEMY_LIMIT] = false;
	matrix[COLLIDER_COLLECTABLE][COLLIDER_COLLECTABLE] = false;
}
...
void j1Collision::DebugDraw()
{
	...
	for (uint i = 0; i < MAX_COLLIDERS; ++i)
	{
		...
		case COLLIDER_PLAYER_ATTACK:
			...
			break;
		case COLLIDER_ENEMY_LIMIT:
			App->render->DrawQuad(colliders[i]->rect, 150, 150, 255, alpha);
			break;
